...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colors.add(new Word("dusty yellow","tozlu sarı",R.drawable.color_dusty_yellow, R.raw.color_dusty_yellow));
        colors.add(new Word("mustard yellow","hardal sarısı", R.drawable.color_mustard_yellow, R.raw.color_mustard_yellow));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(ColorsActivity.this, colors.get(i).getmAudioResourceId());
